...
public class AuthInfo implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        String roles = CmmUtil.nvl(userDTO.getRoles());
    ...
    public String getUsername() {
        return CmmUtil.nvl(userDTO.getUserId());
    ...
    public String getPassword() {
        log.info("pwd : " + CmmUtil.nvl(userDTO.getUserPwd()));
        return CmmUtil.nvl(userDTO.getUserPwd());
    }
